// 经济法第二章公司法律制度互动习题 深度复核验收
// 补充 test-jjf2-v3.js 未覆盖的边界：考点锚点可达性 / 114 题全量疑问流 / 空卷提交
...
['整章思维导图', '公司概述', '有限责任公司', '股份有限公司', '审计委员会', '独立董事', '国有独资公司', '真题印证', '知识链闭环', '全六单元完整详解'].forEach(k => assert(sumTxt.includes(k), `弹框仍含【${k}】`));
