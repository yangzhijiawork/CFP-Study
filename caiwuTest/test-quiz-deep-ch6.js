...
console.log('=== 第六章 深度验收（test-quiz-deep-ch6）===');
...
assert('疑问汇总涉及考点列出', $('#doubtSummary').textContent.includes('投资的分类'));
...
// ---------- 10. 锚点导航点击 ----------
$('#chapterBtn').click();
const targetNav = $('#sumNav .sum-nav-btn[data-k="投资的分类"]');
targetNav.click();
assert('点击导航按钮不报错且存在目标锚点', $('#kp-投资的分类')!==null);
$('#sumClose').click();
