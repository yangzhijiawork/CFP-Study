...
console.log('=== 第七章 深度验收（test-quiz-deep-ch7）===');
...
assert('疑问汇总涉及考点列出', $('#doubtSummary').textContent.includes('营运资金管理概述'));
...
// ---------- 10. 锚点导航点击 ----------
$('#chapterBtn').click();
const targetNav = $('#sumNav .sum-nav-btn[data-k="营运资金管理概述"]');
targetNav.click();
assert('点击导航按钮不报错且存在目标锚点', $('#kp-营运资金管理概述')!==null);
$('#sumClose').click();
