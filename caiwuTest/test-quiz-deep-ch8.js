...
console.log('=== 第八章 深度验收（test-quiz-deep-ch8）===');
...
assert('疑问汇总涉及考点列出', $('#doubtSummary').textContent.includes('本量利分析'));
...
// ---------- 10. 锚点导航点击 ----------
$('#chapterBtn').click();
const targetNav = $('#sumNav .sum-nav-btn[data-k="本量利分析"]');
targetNav.click();
assert('点击导航按钮不报错且存在目标锚点', $('#kp-本量利分析')!==null);
$('#sumClose').click();
