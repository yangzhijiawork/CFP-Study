...
console.log('=== 第十章 深度验收（test-quiz-deep-ch10）===');
...
assert('疑问汇总涉及考点列出', $('#doubtSummary').textContent.includes('财务分析方法'));
...
// ---------- 10. 锚点导航点击 ----------
$('#chapterBtn').click();
const targetNav = $('#sumNav .sum-nav-btn[data-k="财务分析方法"]');
targetNav.click();
assert('点击导航按钮不报错且存在目标锚点', $('#kp-财务分析方法')!==null);
$('#sumClose').click();
