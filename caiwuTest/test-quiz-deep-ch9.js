...
console.log('=== 第九章 深度验收（test-quiz-deep-ch9）===');
...
assert('疑问汇总涉及考点列出', $('#doubtSummary').textContent.includes('收入管理'));
...
// ---------- 10. 锚点导航点击 ----------
$('#chapterBtn').click();
const targetNav = $('#sumNav .sum-nav-btn[data-k="收入管理"]');
targetNav.click();
assert('点击导航按钮不报错且存在目标锚点', $('#kp-收入管理')!==null);
$('#sumClose').click();
